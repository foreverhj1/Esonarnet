...
from nets.model_training import get_lr_scheduler, set_optimizer_lr, weights_init
...
if __name__ == "__main__":
    ...
    pretrained = False
    #------------------------------#
    #   Need download pre-train model path
    #------------------------------#
    model_path = "model_data/pretrain.pth"
    input_shape = [512, 512]
    Init_Epoch = 0
    Freeze_Epoch = 50
    Freeze_batch_size = 2
    ...
    model = Esonarnet(num_classes=num_classes).train()
    ...
    if True:
        ...
        train_dataset = UnetDataset(train_lines, input_shape, num_classes,
                                    True, VOCdevkit_path)
        ...
        for epoch in range(Init_Epoch, UnFreeze_Epoch):
            ...
            fit_one_epoch(model_train, model, loss_history, eval_callback,
                          optimizer, epoch, epoch_step, epoch_step_val, gen,
                          gen_val, UnFreeze_Epoch, Cuda, dice_loss, focal_loss,
