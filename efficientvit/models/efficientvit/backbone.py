...
class EfficientViTBackbone(nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        ...
        # print('----')
        # print(output_dict["stage0"].shape, output_dict["stage1"].shape, output_dict["stage2"].shape, output_dict["stage3"].shape, output_dict["stage4"].shape)
        # print(output_dict["stage_final"].shape)
        return output_dict
